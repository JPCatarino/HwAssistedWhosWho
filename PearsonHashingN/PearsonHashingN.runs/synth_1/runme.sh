...
HD_PWD='C:/HwAssistedWhosWho/PearsonHashingN/PearsonHashingN.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PearsonHashingN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PearsonHashingN.tcl
