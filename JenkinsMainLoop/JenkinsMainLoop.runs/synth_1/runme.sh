...
HD_PWD='C:/HwAssistedWhosWho/JenkinsMainLoop/JenkinsMainLoop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JenkinsMainLoop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JenkinsMainLoop.tcl
