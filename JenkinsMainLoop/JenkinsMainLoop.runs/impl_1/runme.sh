...
HD_PWD='C:/HwAssistedWhosWho/JenkinsMainLoop/JenkinsMainLoop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log JenkinsMainLoop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source JenkinsMainLoop.tcl -notrace
