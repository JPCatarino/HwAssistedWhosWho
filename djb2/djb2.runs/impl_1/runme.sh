...
HD_PWD='C:/HwAssistedWhosWho/djb2/djb2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log djb2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source djb2.tcl -notrace
