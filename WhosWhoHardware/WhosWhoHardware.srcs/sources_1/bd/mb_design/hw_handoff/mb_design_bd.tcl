...
proc create_root_design { parentCell } {
  ...
  # Create instance: PearsonHashingCop_0, and set properties
  set PearsonHashingCop_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:PearsonHashingCop:1.0 PearsonHashingCop_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PearsonHashingCop_0_M00_AXIS [get_bd_intf_pins PearsonHashingCop_0/M00_AXIS] [get_bd_intf_pins microblaze_0/S0_AXIS]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M0_AXIS [get_bd_intf_pins PearsonHashingCop_0/S00_AXIS] [get_bd_intf_pins microblaze_0/M0_AXIS]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins PearsonHashingCop_0/m00_axis_aclk] [get_bd_pins PearsonHashingCop_0/s00_axis_aclk] [get_bd_pins axi_gpio_buttons/s_axi_aclk] [get_bd_pins axi_gpio_display/s_axi_aclk] [get_bd_pins axi_gpio_leds/s_axi_aclk] [get_bd_pins axi_gpio_switches/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins fit_timer_0/Clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
