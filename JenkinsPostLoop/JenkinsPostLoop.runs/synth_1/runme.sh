...
HD_PWD='C:/HwAssistedWhosWho/JenkinsPostLoop/JenkinsPostLoop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JenkinsPostLoop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JenkinsPostLoop.tcl
