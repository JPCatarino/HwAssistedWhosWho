...
HD_PWD='C:/HwAssistedWhosWho/PearsonHashing128PeripheralSim/PearsonHashing128PeripheralSim.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PearsonHashing128Peripheral_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PearsonHashing128Peripheral_v1_0.tcl
