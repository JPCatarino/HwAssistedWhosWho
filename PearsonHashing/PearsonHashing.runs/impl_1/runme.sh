...
HD_PWD='C:/HwAssistedWhosWho/PearsonHashing/PearsonHashing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PearsonHashing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PearsonHashing.tcl -notrace
