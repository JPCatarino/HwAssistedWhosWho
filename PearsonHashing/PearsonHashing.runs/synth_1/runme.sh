...
HD_PWD='C:/HwAssistedWhosWho/PearsonHashing/PearsonHashing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PearsonHashing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PearsonHashing.tcl
